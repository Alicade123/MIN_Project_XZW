...
?>
                        ...
                        <div class="welcome-intro">
                            <h2 class="text-white"><?php print $stitle?></h2>
                            <h3 class="text-white my-4"><?php print $stext?></h3>
                            <!-- Buttons -->
                            <div class="button-group">
                                <a href="about" class="btn btn-bordered-white">About Us</a>
                                <a href="contact" class="btn btn-bordered-white d-none d-sm-inline-block">Contact Us</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-5">
                        ...
                        <div class="welcome-thumb-wrapper mt-5 mt-md-0">
                            <span class="welcome-thumb-1">
                                <img class="welcome-animation d-block ml-auto"  src="assets/img/welcome/thumb_1.png" alt="child">
                            </span>
...
<!-- Single Promo -->
<div class='single-promo color-1 bg-white hover-bottom text-center p-5'>
    <h4 class='mb-3'>$title</h4>
    <a href='aboutthis.php?id=$id'>
        <img src='dashboard/uploads/topshow/$ufile' alt=''>
    </a>
...
?>
        ...
        <!-- ***** Service Area End ***** -->
        <section id="service" class="section service-area bg-overlay ptb_150">
            <!-- Shape Top -->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10 col-lg-7">
                        ...
                        <div class="section-heading text-center">
                            <h2 class="text-white"><?php print $service_title?></h2>
...
<!-- Single Service -->
<div class='single-promo color-1 bg-white hover-bottom text-center p-5'  style='border: solid 3px #788282;'>
    <h5 class='my-3'>$serviceg</h5>
    <p>$service_desc</p>
    <div class='row justify-content-center'>
    <a class='btn btn-bordered mt-4' href='servicedetail.php?id=$id'>Learn More</a>
    </div>
</div><br>
</div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10 col-lg-7">
                        ...
                        <div class="section-heading text-center">
                            <h2 class="text-white"><upper><?php print $test_title; ?></upper></h2>
...
<div class='review-content'>
    <!-- Review Text -->
    <div class='review-text' style='background: #d9d5d5;padding:10px;border: 3px solid green;border-radius:6px;'>
        <p>$message</p>
    </div>
    <!-- Quotation Icon -->
...
<!-- Reviewer -->
<div class='reviewer media mt-0'>
    <!-- Reviewer Thumb -->
    <div class='reviewer-thumb'>
        <img  src='dashboard/uploads/testimony/$ufile' style='background: #d9d5d5;width:50px;height:50px;padding:5px;border: 3px solid green;border-radius:50%;' alt='img'>
    </div>
    <!-- Reviewer Media -->
    <div class='reviewer-meta media-body align-self-center ml-4'>
        <h5 class='reviewer-name color-primary mb-2' style='color:#ffff;'>$name</h5>
        <h6 class='text-secondary fw-6' style='color:grey;'>$position</h6>
    </div>
</div>
</div>
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="section-heading text-center mb-3">
                            <h3 class='text-uppercase' style='color:white;'><?php print $contact_title ?></h3>
                            <p class="d-none d-sm-block mt-4" style='color:white;'><?php print $contact_text ?></p>
                        </div>
                        <!-- Contact Us -->
                        <div class="contact-us">
                            <ul>
                                <!-- Contact Info -->
                                <li class="contact-info color-1 bg-white bg-hover active hover-bottom text-center p-5 m-3">
                                ...
                                <!-- Contact Info -->
                                <li class="contact-info color-3 bg-white bg-hover active hover-bottom text-center p-5 m-3">
                                ...
                                <!-- Contact Info -->
                                <li class="contact-info color-4 bg-white bg-hover active hover-bottom text-center p-5 m-3">
...
print "
<li class='list-inline-item px-1'><a href='$social_link'><span><i class='fab $fa' style='font-size:40px;color:black;'></i></span></a></li>
";
}
?>
...
$result= mail($recipient, $subject, $formcontent);
  ...
  <div class='alert alert-success alert-dismissible alert-outline fade show'>
                   Message Sent Successfully. We shall get back to you ASAP.
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="m_name" placeholder="Name" required="required">
                                        </div>

                                        <div class="form-group">
                                            <input type="email" class="form-control" name="m_email" placeholder="Email" required="required">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="m_phone" placeholder="Phone" required="required">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
