      ...
      <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
              ...
              <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarM" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20">
                                <path fill="currentColor" d="M0 8v8a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-10 4z"/>
                                <path fill="currentColor" d="M2 2a2 2 0 0 0-2 2v2l10 4l10-4V4a2 2 0 0 0-2-2z"/></svg> <span data-key="t-landing">Manage message</span>
                            </a>
                            <div class="menu-dropdown collapse" id="sidebarM" style="">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="message" class="nav-link" data-key="t-nft-landing">Message lists </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
